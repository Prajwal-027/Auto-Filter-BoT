...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003323091407 -1003132672301').split()]  # For Multiple Id Use One Space Between Each.
