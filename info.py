...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002719110541 -1003121843567').split()]  # For Multiple Id Use One Space Between Each.
